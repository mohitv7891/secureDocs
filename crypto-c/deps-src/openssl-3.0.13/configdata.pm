...
our %config = (
    "AR" => "/miniProject/dev/emsdk/upstream/emscripten/emar",
    "ARFLAGS" => [
        "qc"
    ],
    "CC" => "/miniProject/dev/emsdk/upstream/emscripten/emcc",
    "CFLAGS" => [
        "-Wall -O3"
    ],
    "CPPDEFINES" => [],
    "CPPFLAGS" => [],
    "CPPINCLUDES" => [],
    "CROSS_COMPILE" => "/miniProject/dev/emsdk/upstream/emscripten/em",
    "CXX" => "/miniProject/dev/emsdk/upstream/emscripten/em++",
    "CXXFLAGS" => [
        "-Wall -O3"
    ],
    "FIPSKEY" => "f4556650ac31d35461610bac4ed81b1a181b2d8a43ea2854cbae22ca74560813",
    "HASHBANGPERL" => "/usr/bin/env perl",
    "LD" => "/miniProject/dev/emsdk/upstream/emscripten/emcc",
    "LDFLAGS" => [],
    "LDLIBS" => [],
    "PERL" => "/usr/bin/perl",
    "RANLIB" => "/miniProject/dev/emsdk/upstream/emscripten/emranlib",
    "RC" => "windres",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30000",
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "--prefix=/miniProject/dev/crypto-wasm-test/wasm-libs no-acvp-tests no-afalgeng no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-makedepend no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tests no-threads no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "13",
...
unless (caller) {
    ...
    use lib '/miniProject/dev/crypto-wasm-test/deps-src/openssl-3.0.13/util/perl';
    use OpenSSL::fallback '/miniProject/dev/crypto-wasm-test/deps-src/openssl-3.0.13/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/miniProject/dev/crypto-wasm-test/deps-src/openssl-3.0.13/Configurations';
        use gentemplate;
